...
class CalendarException(Exception):
	...
	def __init__(self, valor):
		self.valor = valor
		self.exception_list = [_("No se ha podido acceder a la base de datos"), _("Problema interno en BD"), _("Usuario no existe en BD")]
...
class PyCouchDAO ():	
	...
	def __init__(self, dbname = None):	
			self.db_name = "bdihm" #Este es nuestro nombre por defecto para la BD
			if dbname != None:
				self.db_name = dbname
			try:
